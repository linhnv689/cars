! function (e) {
    ...
    var t = {
        ...
        jws_theme_open_menu: function () {
            ...
            const ovelayMenu = document.querySelector('.overlay-menu');
            ...
            if (menuBtn) {
                menuBtn.addEventListener('click', () => {
                    ...
                    mobileNavSub.classList.remove('active');
                    ovelayMenu.classList.remove('active');
                });
            }
        ...
        jws_theme_hover_play_video: function () {
            ...
            // Auto‑pause when pointer exits viewport
