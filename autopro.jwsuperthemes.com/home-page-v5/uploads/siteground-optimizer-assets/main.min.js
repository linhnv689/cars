! function (e) {
    ...
    var t = {
        ...
        jws_theme_custom_scroll_v4: function () {
            ...
            0 !== n.length && (e("#mobile-bar-v4,.br-button").on("click", function () {
                n.toggleClass("active"), e(".menu-item-has-children > a ").removeAttr("href")
                ...
                e(window).width() < 767 || !n.hasClass("active") && !t.ev_sidebar || n.removeClass("active")
            }))
        },
    ...
    e(document).ready(function () {
        setTimeout(function () {
            var e = $("template").last().attr("id");
            $("#" + e).css("display", "none"), $("#" + e).next().next().css("display", "none")
        }, 100);
