...
<script type='text/javascript' src='<?php echo $root_path; ?>/assets/js/jquery/jquery-3.7.1.min.js'></script>
<script type='text/javascript' src='<?php echo $root_path; ?>/assets/js/main3b3c.js?v=213'></script>

<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/Draggable.min.js"></script>
<script type='text/javascript' src='<?php echo $root_path; ?>/assets/js/main.js' id='rimacWeb2020Main-js'></script>
